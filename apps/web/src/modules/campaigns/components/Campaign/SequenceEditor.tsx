              ...
              {msg.type === 'text' ? (
                <div className="flex flex-col gap-2">
                  <div className="flex flex-wrap gap-1.5 mb-0.5">
                    ...
                    <button type="button" onClick={() => updateMessage(msg.id, { content: msg.content + '{{nombre}} ' })} className="text-[11px] px-2 py-0.5 rounded border border-slate-300 dark:border-slate-600 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 cursor-pointer flex items-center gap-1 hover:bg-slate-200 dark:hover:bg-slate-600"><span>👤</span> Nombre Cliente</button>
