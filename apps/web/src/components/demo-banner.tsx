...
export default function DemoBanner({ active }: { active: boolean }) {
  ...
  return (
    <div className="relative z-[60] flex w-full flex-col items-center justify-center gap-2 bg-gradient-to-r from-pink-600 to-rose-600 px-4 py-2.5 text-white shadow-md sm:flex-row sm:gap-4">
      <span className="text-center text-xs font-semibold sm:text-sm">
        Vista demo de solo lectura · Puedes recorrer el sistema, pero no modificar datos · Vence en
        24 horas
      </span>
      <a
